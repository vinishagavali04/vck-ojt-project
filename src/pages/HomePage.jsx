    ...
    return(
        ...
        <div className="main-container">
         <div className="page-container" style={{ overflow:"auto"}}>
            ...
            <img  src="https://vck-ojt.vercel.app/assets/students-studying-DbLGuwF_.jpeg" alt="Students studying in library"/>
            <img  src="https://vck-ojt.vercel.app/assets/campus-life-Crkero7B.jpg" alt="Students on campus ground"/>
            </div>
